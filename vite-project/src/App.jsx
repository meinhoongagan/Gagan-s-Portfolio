  ...
  return (
    <div className="font-sans bg-neutral-950 text-neutral-100">
      ...
      <section id="hero" className="min-h-screen flex items-center pt-20 relative overflow-hidden">
        ...
        <div className="absolute top-1/3 right-0 w-[32rem] h-[32rem] bg-violet-600/10 rounded-full blur-[120px]"></div>
        <div className="absolute bottom-0 left-0 w-[24rem] h-[24rem] bg-fuchsia-600/5 rounded-full blur-[100px]"></div>
        ...
        <div className="container mx-auto px-6 py-12 md:flex md:items-center md:justify-between relative z-10">
          <div className="md:w-3/5 mb-12 md:mb-0">
            <div className="inline-flex items-center gap-2 px-3 py-1 mb-6 rounded-full bg-white/5 border border-white/10 text-neutral-300 text-sm">
            ...
            <h2 className="text-lg md:text-xl font-medium text-violet-300 mb-6">
              Software engineer specializing in AI infrastructure and distributed systems
            </h2>
            <p className="text-neutral-400 mb-8 leading-relaxed max-w-xl">
...
{"\n"}{"}"};
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {skills.map((skillCategory, index) => (
              <div
                key={index}
                className="bg-white/[0.03] p-6 rounded-xl border border-white/10 hover:border-violet-500/40 transition-colors duration-200"
              >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {experiences.map((exp, index) => (
              <div key={index} className="bg-white/[0.03] p-6 rounded-xl border border-white/10 hover:border-violet-500/40 transition-colors duration-200">
      ...
      <section id="projects" className="py-24 relative border-t border-white/5">
        <div className="container mx-auto px-6">
          ...
          <p className="text-neutral-400 text-center max-w-xl mx-auto mb-14 text-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-20">
            {featuredProjects.map((project, index) => (
              <div
                key={index}
                className="bg-white/[0.03] rounded-2xl border border-white/10 p-8 hover:border-violet-500/40 transition-colors duration-200 flex flex-col"
              >
          ...
          <h3 className="text-xl font-semibold mb-10 text-center text-white">Other Projects</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project, index) => (
              <div
                key={index}
                className="bg-white/[0.03] rounded-xl overflow-hidden border border-white/10 hover:border-violet-500/40 transition-colors duration-200 group"
              >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {educationData.map((edu, index) => (
              <div
                key={index}
                className="bg-white/[0.03] p-7 rounded-xl border border-white/10 hover:border-violet-500/40 transition-colors duration-200"
              >
